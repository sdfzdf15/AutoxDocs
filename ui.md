...
可以通过这些属性的组合让控件处于父容器的左上角、右上角、左下角、右下角、上居中、下居中、左居中、右居中、正居中的位置。例如给一个控件添加`layout_alignParentLeft="true"`和`layout_alignParentBottom="true"`属性后，该控件将以父容器为参照物，使控件位于父容器的左下角。
...
$ui.layout(
    <relative w="match_parent" h="match_parent">
...
-   `layout_toLeftOf="@id/button1"` 以兄弟控件（button1）作为参照物，使控件在兄弟控件 button1 的左方。
...
-   `layout_alignTop="@id/button1"` 以兄弟控件（button1）作为参照物，使控件与兄弟控件 button1 的顶部平齐。
-   `layout_alignBottom="@id/button1"` 以兄弟控件（button1）作为参照物，使控件与兄弟控件 button1 的底部平齐。

可以通过这 8 个属性的组合让控件处于兄弟控件的左上角、右上角、左下角、右下角、正上方、正下方、正左方、正右方等位置。例如给一个控件添加`layout_toRightOf="@id/button1"`和`layout_above="@id/button1"`属性后，该控件将以兄弟控件为参照物，使控件位于兄弟控件的右上角。
